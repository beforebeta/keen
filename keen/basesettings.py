...
DATABASES = {
    'default': {
        ...
        'NAME': 'keen',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['localhost','keensmb.com','www.keensmb.com','198.199.75.210','*']
...
SECRET_KEY = 'c67ar52yduljft-bdc$6h^f6pzpxnz5=s#xtm2yc+wqsjh-&m='
